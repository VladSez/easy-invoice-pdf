  ...
  return (
    ...
    >
      <CarouselContent className="-ml-3 items-center">
        ...
        {/* Badge for Trending on BuildHop */}
        <BadgeSlide>
          <a
        ...
        {/* Badge for Launched on StartupBase */}
        <BadgeSlide>
          <a
            href="https://startupbase.io/products/easyinvoicepdf?utm_source=startupbase&utm_medium=badge&utm_campaign=launch-badge-light"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
        ...
        {/* Badge for Featured on DanielLaunches */}
        <BadgeSlide>
...
function BadgeSlide({ children }: { children: ReactNode }) {
  return (
    <CarouselItem className="flex basis-auto items-center pl-3">
      {children}
    </CarouselItem>
  );
}
