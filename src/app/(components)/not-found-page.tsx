"use client";
// needs to be "use client" here to prevent an error: https://nextjs.org/docs/messages/dynamic-server-error

import Link from "next/link";

/**
 * The 404 page. Rendered by the `not-found.tsx` of both root layouts
 * (`src/app/(main)` and `src/app/[locale]`), so it stays in one place.
 */
