...
import {
  CTA_TOAST_TIMEOUT,
  showCTAToast,
} from "@/app/(main)/(app)/components/cta-toasts";
import { CTAToastProvider } from "@/app/(main)/(app)/contexts/cta-toast-context";
...
vi.mock("@/app/(main)/(app)/utils/get-app-metadata", () => {
  return {
    updateAppMetadata: vi.fn(),
  };
});

vi.mock("@/app/(main)/(app)/components/cta-toasts", async () => {
  const actual = await vi.importActual(
    "@/app/(main)/(app)/components/cta-toasts",
  );
