...
export default function AboutLoading() {
  return (
    <div className="flex min-h-screen flex-col bg-slate-50">
            ...
            `}>
              {Array.from({ length: 6 }).map((_, i) => (
                <div
                  key={i}
                  className={`
                    flex h-full flex-col items-start gap-4 rounded-lg border border-slate-100
                    bg-white p-6
                  `}
                >
      ...
      {/* Footer */}
      <footer className={`
        flex w-full items-center justify-center border-t border-slate-200 bg-white py-12
        md:py-16
        lg:py-20
      `}>
        <div className={`
