...
function PremiumDonationToast(props: ToastProps) {
  ...
  return (
    <div
      className="relative max-w-sm rounded-lg border border-indigo-200 bg-linear-to-br from-indigo-50 via-white to-purple-50 p-4 shadow-xl"
...
function PremiumToastFeedbackButton(
  ...
  return (
    <Button
      _size="sm"
      className="h-8 flex-1 bg-linear-to-r from-green-500 to-blue-600 text-xs text-white transition-all duration-200 hover:from-green-600 hover:to-blue-700 hover:shadow-lg"
      asChild
...
function PremiumToastDonationButton(
  ...
  return (
    <Button
      _size="sm"
      className="h-8 flex-1 bg-linear-to-r from-indigo-500 to-purple-600 text-xs text-white transition-all duration-200 hover:from-indigo-600 hover:to-purple-700 hover:shadow-lg"
      asChild
      data-testid="toast-cta-btn"
    >
      <a
...
function DefaultDonationToast(props: ToastProps) {
  ...
  return (
    <div
      className="flex max-w-md items-start gap-3 rounded-lg border border-indigo-200 bg-linear-to-br from-indigo-50 via-white to-purple-50 p-4 shadow-xl"
      data-testid="download-pdf-toast"
    >
      {/* Close button - styled like default Sonner toast */}
      <SonnerCloseButton onClick={() => sonnerToast.dismiss(id)} />

      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-linear-to-br from-pink-500 to-purple-600">
...
function DefaultToastDonationButton(
  ...
  return (
    <Button
      _size="sm"
      className="h-7 bg-linear-to-r from-pink-500 to-purple-600 px-3 text-xs font-medium text-white shadow-lg transition-all duration-200 hover:scale-105 hover:from-pink-600 hover:to-purple-700"
      asChild
      data-testid="toast-cta-btn"
    >
      <a
...
function DefaultToastFeedbackButton(
  ...
  return (
    <Button
      _size="sm"
      className="h-7 bg-linear-to-r from-green-500 to-blue-600 px-3 text-xs font-medium text-white shadow-lg transition-all duration-200 hover:scale-105 hover:from-green-600 hover:to-blue-700"
      asChild
      data-testid="toast-cta-btn"
    >
      <a
